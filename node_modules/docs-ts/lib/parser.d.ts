...
export declare type Parser<A> = E.Either<Array<string>, A>;
...
export declare function documentable(name: string, description: O.Option<string>, since: O.Option<string>, deprecated: boolean, examples: Array<Example>): Documentable;
...
export declare function module(path: Array<string>, description: O.Option<string>, interfaces: Array<Interface>, typeAliases: Array<TypeAlias>, functions: Array<Func>, classes: Array<Class>, constants: Array<Constant>, exports: Array<Export>, deprecated: boolean): Module;
export declare const monadParser: import("fp-ts/lib/Monad").Monad2C<"Either", string[]> & import("fp-ts/lib/Alt").Alt2C<"Either", string[]>;
